...
public class StaffMemberList {
	...
	public void addMember(Member m) {
		...
		mArray[numMembers] = new StaffMember(m.getName(), m.getUserID(), null, m.getStrikes(), m.getAccountHold().toString());
		System.out.println(mArray[numMembers].toString());
		numMembers++;
    	System.out.println(m.getUserID() + " is now staff.");
		saveList();
	}
