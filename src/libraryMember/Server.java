        ...
        public void run() {
            ...
            try {
                ...
                private Message handleInventoryActions(Message msg) {
                    // Process Inventory-related actions here
                    // You can implement your actions based on secondary header like SEARCH, ADD, etc.
                    return new Message(Header.NET, Header.ERR, "Unknown request", "server", "client", "server", "client");
                }
					...
					case Header.CREATE:
                        ...
                        case Header.LOGIN:
                            ...
                            if (credentials.length == 2) {
                                ...
                                else if(goodCred.toString().equals("2")) {
